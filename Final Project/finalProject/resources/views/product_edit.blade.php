                    ...
                    <div class="card-body">
                        <form action="{{ route('product.update',$product->product_id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="product_desc" id="product_desc" value="{{ $product->product_desc}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <x-adminlte-select2 name="category_name" id="category">
                                        <option value="{{ $product->category_name}}" selected>{{ $product->category_name}} (Current)</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <x-adminlte-select2 name="status" id="status">
                                        <option value="{{ $product->status }}" selected>{{ $product->status }} (Current)</option>
