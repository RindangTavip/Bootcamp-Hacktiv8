                    ...
                    <div class="card-body">
                        <form action="{{ route('customer.update',$customer->customer_id) }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="customer_fullname" id="customer_fullname" value="{{ $customer->customer_fullname}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="customer_email" class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="customer_email" id="customer_email" value="{{ $customer->customer_email }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="customer_gender" id="customer_gender"
                                            value="male" @if($customer->customer_gender =='male') {{ 'checked' }} @endif>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="customer_gender" id="customer_gender"
                                            value="female"
                                            @if($customer->customer_gender =='female') {{ 'checked' }} @endif
                                            >
